...
using SecureSwap.SecureERC20.ContractDefinition;

namespace SecureSwap.SecureERC20
{
    public partial class SecureERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, SecureERC20Deployment secureERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<SecureERC20Deployment>().SendRequestAndWaitForReceiptAsync(secureERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, SecureERC20Deployment secureERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<SecureERC20Deployment>().SendRequestAsync(secureERC20Deployment);
        }

        public static async Task<SecureERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, SecureERC20Deployment secureERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, secureERC20Deployment, cancellationTokenSource);
            return new SecureERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public SecureERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public SecureERC20Service(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
